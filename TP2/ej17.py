...
class FuncionesPrograma:
    ...
    def getFechaString(fecha):
        ...
        print(f"{dayi.capitalize()} de {monthi} de{yeari[0]} mil{yeari[1]}{yeari[2]}")

FuncionesPrograma.getFechaString("15/10/1900")
FuncionesPrograma.getFechaString("15/10/2024")
FuncionesPrograma.getFechaString("15/10/3335")
